...
const MetaDecorator = (props) => {
  ...
  let description = props.description !== undefined ? props.description  : "STAY UPDATED. LIGHTNING FAST UPDATES FROM VARIOUS SOURCES AT ONE PLACE.";
  let hashtag = props.hashtag !== undefined ? props.hashtag : "#mahabuzz";
return (
<Helmet>
    <title>{title}</title>
    <meta charset="utf-8" />
